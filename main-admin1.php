...
<html lang="en">
            ...
            <div class = "btn-group-vertical">
                ...
                <div>
                    <a href = "main-admin.php">
                        <input type = "submit" class = "btnbtn-defaul" value="Ubah Status Lunas ">
                    </a>
                    <a href = "main-admin1.php">
                        <input type = "submit" class = "btnbtn-defaul" value="Ubah Status Belum Lunas ">
                    </a>
                </div>
            </div>
        </div>
 ...
 <div id="formholder" class="col-8" style="margin-top: -;">
    <form id="form1" name="form1" method="POST" action="fungsi-belumlunas.php">
        <div class = "input">
            <div class = "box2">
                ...
                <div>
                    ...
                    <input name = "login" type = "submit" value = "Ubah" class = "btn" />
                </div>
            </div>
        </div>
    </form>
