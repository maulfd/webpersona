...
<?php
	...
	if(empty($nama)){
		...
		mysql_query("insert into kehadiran(nama_team, jumlah, konfirmasi_oleh, tema_team, keterangan, tanggal_konfirmasi) values ('$nama', '$jumlah', '$oleh', 
			'$tema', '$_POST[konfirmasi]', '$tanggal_sekarang')") or die (mysql_error());
