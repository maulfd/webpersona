...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="Content/css/tambah-admin.css">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Bootstrap core CSS -->
 ...
 <div id="formholder" style="margin-top: -;">
    <form id="form1" name="form1" method="POST" action="fungsi_tambah.php">
        <div class = "input">
            <div class = "box2">
                <div>
                    <input name = "txt_username" type = "text" id = "username" placeholder= "Masukan Username Baru" />
                </div>
                <div>
                    <input name = "txt_password" type = "password" id = "password" placeholder= "Masukan Password" />
                </div>
                <div>
                    <input name = "txt_nama-team" type = "text" id = "username" placeholder= "Masukan Nama Team" />
                </div>
                <div>
                    <input name = "txt_level" type = "text" id = "username" placeholder= "Masukan Level User" />   
                </div>
                <div>
                    
                    <input name = "login" type = "submit" value = "Simpan" class = "btn" />
                </div>
