...
<title>Persona 3</title>
    <link href="assets/css/main-login.css" rel="stylesheet" type="text/css" />
<!--[if It IE 6 || 7]>
        ...
        <div class="input">
           <form action = "" method = "post">
                ...
                <div>
                    ...
                    <input type = "username" name = "ID" placeholder = "ID Anda" class = "username" />
                </div>  
                <div>
                        
                    <input type = "password" name = "Password" placeholder = "Password Anda" class = "password" />    
                </div>                     
           ...
           <?php
               ...
               if($login){
                    ...
                    if($username == "" || $password == "") {
                        ...
                        $sql = mysql_query("select * from daftar_admin where ID = '$username' and Password = '$password'") or die (mysql_error());
                        ...
                        if($cek >= 1){
                            ...
                            ?>
                            <script>location.href='main-admin.php';</script>
                            <?php
                        }
                        else{
...
<div class="footerBottomSection">
        <div class="container">
            <h3><center>&copy; Persona 3</center></h3>
        </div>
</div>
